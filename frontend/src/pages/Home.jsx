    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
            ...
            <div className="flex flex-wrap gap-6">
              <Button asChild size="lg" className="bg-linear-to-r from-purple-600 to-fuchsia-600 hover:from-purple-500 hover:to-fuchsia-500 text-white rounded-full px-10 py-7 text-lg shadow-2xl shadow-purple-900/50">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-light mb-4">
              Available <span className="font-medium bg-linear-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">Courses</span>
            </h2>
      ...
      <section className="py-32 text-center">
        <h2 className="text-5xl lg:text-6xl font-light mb-20">
          Built for <span className="font-medium bg-linear-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">serious learners</span>
        </h2>
      ...
      <section className="py-32 text-center">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
          <h2 className="text-5xl lg:text-7xl font-light mb-8">
            Start your journey <span className="block font-medium bg-linear-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">today</span>
          </h2>
          <Button asChild size="lg" className="bg-linear-to-r from-purple-600 to-fuchsia-600 hover:from-purple-500 hover:to-fuchsia-500 text-white rounded-full px-12 py-8 text-xl shadow-2xl shadow-purple-900/50">
